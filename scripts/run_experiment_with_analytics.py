#!/usr/bin/env python
"""Convenience wrapper to launch the *experiments_with_analytics* pipeline.

This is functionally equivalent to executing the Bash script
`scripts/run_experiment_with_analytics.sh`, but can be invoked directly from a
Python environment or a debugger, easing interactive development and
troubleshooting.

Example
-------
python scripts/run_experiment_with_analytics.py \
    --input_path /app/datasets/csvs \
    --output_dir samples
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Run the experiments_with_analytics multi-table pipeline.",
...
def main() -> None:  # noqa: D401 (no imperative mood requirement)
    ...
    for i in range(10):
        run_pipeline(
            ...
            pipeline="experiments_with_analytics",
        )
